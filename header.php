                        ...
                        <ul>
                            <li class="d-flex align-items-center">
                                ...
                                <div class="offcanvas__contact-text">
                                    <a target="_blank" href="#">1/6/55, Sector J, Pocket 6, Sushant Golf City, Lucknow - 226030, UP, India</a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                    ...
                                    <ul>
                                        ...
                                        <li class="has-dropdown">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li>
                                                    <a href="startup-accelerator.php">Startup Accelerator</a>
                                                </li>
                                                <li>
                                                    <a href="reviving-sick-industries.php">Reviving Sick Industries</a>
                                                </li>
                                                <li><a href="waste-management.php">Waste Management</a></li>
                                                <li><a href="horticulture-landscaping.php">Agriculture & Horticulture</a></li>
